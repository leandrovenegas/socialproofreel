# Graph Report - Y:\proyects\socialproofreel  (2026-07-14)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 328 nodes · 400 edges · 38 communities (27 shown, 11 thin omitted)
...
Cohesion: 0.10
Nodes (18): updateSettingsAction(), quickLinks, EditorSidebar(), SettingsClient(), SettingsClientProps, defaultConfig, TemplateConfig, TemplateContext (+10 more)
...
Cohesion: 0.33
Nodes (5): addLeadAction(), generateVideoTaskAction(), LeadForm(), TriggerButton(), Lead

### Community 10 - "LeadDetail.tsx"
Cohesion: 0.24
...
### Community 11 - "render_remotion.py"
Cohesion: 0.27
...
### Community 19 - "search-both.js"
Cohesion: 0.40
Nodes (3): fs, path, results

### Community 20 - "upload_raw_leads.mjs"
Cohesion: 0.40
...
## Knowledge Gaps
- **127 isolated node(s):** `BotStatus`, `BotDashboardClientProps`, `LeadItem`, `QueueClientProps`, `metadata` (+122 more)
